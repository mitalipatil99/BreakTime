...
public class InterestCategory {
	public static ArrayList<ArrayList<String>> interests = new ArrayList<ArrayList<String>>();
	...
	public static String getNotification(ArrayList<Integer> interestsIds) {
		Random x = new Random();
		int y,y1;
		
		 y = x.nextInt(interestsIds.size());

	 
		 y1 = x.nextInt(interests.get(interestsIds.get(y)).size());
		
	
		 return interests.get(interestsIds.get(y)).get(y1);
	}
}
